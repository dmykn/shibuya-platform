...
export async function POST(req) {
  ...
  try {
    ...
    const docRef = await adminDb.collection("articles").add({
      ...
      poster: body.poster || "",
      author: body.author || adminCheck.decoded?.email || "فريق شيبويا",
...
export async function PUT(req) {
  ...
  try {
    ...
    await adminDb.collection("articles").doc(id).set({ ...data, updatedAt: adminInstance.firestore.FieldValue.serverTimestamp() }, { merge: true });
